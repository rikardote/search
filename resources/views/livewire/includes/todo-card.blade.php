<div wire:key="{{ $todo->id }}"
    class="todo mt-4 mb-5 card px-5 py-6 bg-white col-span-1 border-t-2 border-blue-500 hover:shadow">
    ...
    <span class="text-xs text-gray-500"> {{ $todo->created_at->format('d/m/Y') }} </span>
